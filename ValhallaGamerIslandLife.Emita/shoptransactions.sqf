...
private ["_menge"];
if (shopactivescript == 1) exitwith {player groupchat "Please Exit The Shop And Re-Enter"};
...
{
if (shopactivescript == 1) exitwith {player groupchat "Please Exit The Shop And Re-Enter To Purchase More Items"};
shopactivescript = 1;
instock=true;
...
{
if (shopactivescript == 1) exitwith {player groupchat "Please Exit The Shop And Re-Enter To Sell More Items"};
shopactivescript = 1;
maxstock=false;
_stock    = [_item, INV_ActiveShopNumber] call INV_getstock;
