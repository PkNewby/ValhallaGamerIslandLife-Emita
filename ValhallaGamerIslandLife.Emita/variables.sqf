...
GesetzAnzahl             = 12;         				
GesetzArray              = ["Always Drive on the LEFT side of the road","Always Holster weapons in Towns.","Speed limits 60 in town 90 out", "Governor and Guards May have any weapon unlicensed","Governor is immune to traffic laws","","","","","","","","","",""];
