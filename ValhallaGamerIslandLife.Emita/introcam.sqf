...
{
titletext ["You are playing as a COP, FOLLOW THE RULES AND YOU MUST BE ON TEAMSPEAK!","plain"];
sleep 5;
...
{
titletext ["You are playing as a Fire and Rescue, FOLLOW THE RULES AND YOU MUST BE ON TEAMSPEAK!!","plain"];
sleep 25;
};